...
/* USER CODE BEGIN PFP */
extern void dns_demo(wiz_NetInfo *net_info);
extern int tcp_process(uint8_t sn, uint16_t port);
extern void mqtt_publish_subscribe_demo(wiz_NetInfo *net_info);
/* USER CODE END PFP */
...
int main(void)
{
  ...
  LCD_Init();
  LCD_DrawImage(0, 0, img_background, 480, 320);

  LCD_DrawImage(24, 65, img_fire_0, 110, 60);
  LCD_DrawImage(24, 152, img_gas_0, 110, 60);
  LCD_DrawImage(24, 239, img_door_0, 110, 60);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : SENSOR1_Pin SENSOR2_Pin W5x00_INT_Pin */
  GPIO_InitStruct.Pin = SENSOR1_Pin|SENSOR2_Pin|W5x00_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : SENSOR0_Pin */
...
void StartDefaultTask(void *argument)
{
  ...
  for(;;)
  {
    if((retval = tcp_process(2, 5000)) < 0) {
      printf(" loop_tcps error : %d\r\n", retval);
      while (1) ;
    }
...
void StartMQTTTask(void *argument)
{
  ...
  mqtt_publish_subscribe_demo(NULL);
